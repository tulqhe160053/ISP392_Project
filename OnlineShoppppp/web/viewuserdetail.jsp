                    ...
                    <div class="border-right d-flex justify-content-center align-items-center ">
                        <form action="user?action=edituser&uid=${user.userID}" method="post">
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12"><label for = "pwd">Username</label><input name="username" type="text" class="form-control" placeholder="enter user number" value="${user.getUserName()}" readonly></div>
                                ...
                                <div class="row mt-3 ml-4">
                                    ...
                                    <div class="col-md-12 mt-3"><label for = "pwd">Email</label><input readonly="" name="email" type="email" class="form-control" placeholder="enter email" value="${user.getEmail()}"></div>
