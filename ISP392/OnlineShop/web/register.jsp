                    ...
                    <div class="col-lg-6">
                        <div class="login_form_inner pt-3">
                            ...
                            <form class="row login_form pt-2" action="register" method="post" id="contactForm" novalidate="novalidate">
                                ...
                                <div class="col-md-12 form-group">
                                    <input type="password" class="form-control" id="name" name="repass" placeholder="RePassword" onfocus="this.placeholder = ''" onblur="this.placeholder = 'RePassword'">
                                </div>
                                
                                <div class="col-md-12 form-group">
                                    <input type="text" class="form-control" id="name" name="gender" placeholder="Gender" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Gender'">
                                </div>
