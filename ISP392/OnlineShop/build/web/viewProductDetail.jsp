	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
                                    <img class="img-fluid" src="product_img/${product.getCategory().categoryName}/${product.getBrand().brandName}/${requestScope.productImg.productImgUrl}" alt="">
				</div>
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						...
						<ul class="list">
							<li><a class="active" href="category?catId=${product.getCategory().getCategoryId()}"><span>Category:</span> ${product.getCategory().getCategoryName()}</a></li>
